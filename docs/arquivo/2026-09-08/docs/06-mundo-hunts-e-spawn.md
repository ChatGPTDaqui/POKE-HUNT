...
> Datas, comandos e pendências descrevem a base antiga. [Original preservado no Git](https://github.com/ChatGPTDaqui/POKE-HUNT/blob/016f1240dcb09788c8c44eb52b1be8044e52f190/docs/06-mundo-hunts-e-spawn.md).
...
> uma arquitetura que não roda mais. Ver [13](https://github.com/ChatGPTDaqui/POKE-HUNT/blob/016f1240dcb09788c8c44eb52b1be8044e52f190/docs/13-divergencias-conhecidas.md) para o registro
...
[05](https://github.com/ChatGPTDaqui/POKE-HUNT/blob/016f1240dcb09788c8c44eb52b1be8044e52f190/docs/05-regras-de-negocio.md)) carregam `evolvesAtLevel = 80` — a regra do JOGADOR (Nível 80 +
...
- O peso de spawn continua sendo o `spawn_tier` real do Gen 1/2 do **próprio estágio**. A
  ...
  `muito_comum` do Magikarp — ver [02](https://github.com/ChatGPTDaqui/POKE-HUNT/blob/016f1240dcb09788c8c44eb52b1be8044e52f190/docs/02-dados-e-catalogo.md#tier-de-spawn-por-que-o-peso-deixou-de-ser-catchrate).
...
zero com `buildMapWorld` (ver [04](https://github.com/ChatGPTDaqui/POKE-HUNT/blob/016f1240dcb09788c8c44eb52b1be8044e52f190/docs/04-autoridade-do-servidor.md)). O inimigo em campo **não**
...
WILD_AGGRO_RADIUS` — ver [03](https://github.com/ChatGPTDaqui/POKE-HUNT/blob/016f1240dcb09788c8c44eb52b1be8044e52f190/docs/03-motor-de-simulacao.md#combate-combatsystemts) para o resto
do pipeline de dano.
...
segurança" para o `autoSystem` — ver [05](https://github.com/ChatGPTDaqui/POKE-HUNT/blob/016f1240dcb09788c8c44eb52b1be8044e52f190/docs/05-regras-de-negocio.md#automação).
...
- Limite caminhável circular por padrão (`mapWalkRadius`, ver
  [03](https://github.com/ChatGPTDaqui/POKE-HUNT/blob/016f1240dcb09788c8c44eb52b1be8044e52f190/docs/03-motor-de-simulacao.md#movimento-movementsystemts)); retangular-pintado nas salas com
