...
> Datas, comandos e pendências descrevem a base antiga. [Original preservado no Git](https://github.com/ChatGPTDaqui/POKE-HUNT/blob/016f1240dcb09788c8c44eb52b1be8044e52f190/docs/01-arquitetura.md).
...
a autoridade deveria fechar. Ver [04](https://github.com/ChatGPTDaqui/POKE-HUNT/blob/016f1240dcb09788c8c44eb52b1be8044e52f190/docs/04-autoridade-do-servidor.md).
...
| `src/features/` | Telas |
| `src/components/game/` | Primitivos de UI em `em` (ver [09](https://github.com/ChatGPTDaqui/POKE-HUNT/blob/016f1240dcb09788c8c44eb52b1be8044e52f190/docs/09-interface.md)) |
