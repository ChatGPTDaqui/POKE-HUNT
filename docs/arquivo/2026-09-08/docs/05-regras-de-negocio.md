...
> Datas, comandos e pendências descrevem a base antiga. [Original preservado no Git](https://github.com/ChatGPTDaqui/POKE-HUNT/blob/016f1240dcb09788c8c44eb52b1be8044e52f190/docs/05-regras-de-negocio.md).
...
decidir balanceamento em cima deste texto** — ver [13](https://github.com/ChatGPTDaqui/POKE-HUNT/blob/016f1240dcb09788c8c44eb52b1be8044e52f190/docs/13-divergencias-conhecidas.md) para o
...
`EXP_GAIN` é a fórmula escalada de Ultra Sun (Gen VII, ver [02](https://github.com/ChatGPTDaqui/POKE-HUNT/blob/016f1240dcb09788c8c44eb52b1be8044e52f190/docs/02-dados-e-catalogo.md)):
...
Sun — ver [02](https://github.com/ChatGPTDaqui/POKE-HUNT/blob/016f1240dcb09788c8c44eb52b1be8044e52f190/docs/02-dados-e-catalogo.md)): 4 `ball`, 4 `potion`, 2 `revive`, **6 `status_heal`**
