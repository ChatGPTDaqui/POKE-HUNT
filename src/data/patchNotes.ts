...
export const PATCH_NOTES: PatchNoteEntry[] = [
  ...
  //     encanamento, zero efeito na tela alem dos itens abaixo.
  {
    ...
    highlights: [
      'A TELA DE HUNTS SE LÊ DE RELANCE. Cada bioma virou uma miniatura da arte dele, com borda na cor do elemento. O número do estágio fica sempre visível (concluído é borda verde, não mais um "✓" no lugar do número), e passar o cursor mostra nível, salas e sub-biomas sem clicar.',
      'CADA ESTÁGIO DIZ QUEM APARECE LÁ, E COM QUE CHANCE. Retrato, tipos, porcentagem de aparição, o quanto seu POKE em campo bate naquela espécie, e quem pode sair como Guardião ou Lorde. As abas em cima da lista mostram a chance DENTRO de um sub-bioma específico.',
      'ENTRAR NUMA ÁREA VIROU UMA APRESENTAÇÃO. A arte do lugar ocupa a tela com zoom e o nome em letreiro, ao entrar num estágio e a cada troca de sala. Não é espera nova — antes esses mesmos segundos mostravam só "Entrando em nova área..." e um número, sem dizer qual área.',
      'BUG CORRIGIDO: O CHEFE DA SALA, e eram três defeitos somados. Matar o Guardião não fazia nada; a sala às vezes trocava no meio da luta; e o chefe voltava inteiro depois de uma caçada em segundo plano. A causa comum: o servidor e a sua tela lutavam contra chefes DIFERENTES na mesma sala. Agora é um só. Nenhum progresso foi perdido — o que quebrava era a contagem.',
      'O CHEFE AGORA É O 30º POKE DA SALA, E NÃO O 31º. A barra para em 29/30 quando ele entra em campo, e o abate dele fecha os 30 e leva pra sala seguinte no mesmo instante. Um selvagem comum a menos por sala, e nenhum outro nasce depois que ele aparece.',
      'BUG CORRIGIDO: O BIOMA NÃO AFUNDAVA DE VERDADE. A trilha mostra a composição de sub-bioma mudando ao longo dos dez estágios, mas o sorteio das salas ignorava isso — no fundo do Marinho a Praia aparecia em quase um terço das salas, anunciada como 0%. Agora vale, e por isso O QUE APARECE NAS SALAS MUDOU em toda hunt de bioma.',
      'A ARTE DE GOLPE QUE MUDA ATRIBUTO AGORA DIZ QUAL ATRIBUTO. Antes ela saía do tipo elemental, então Ataque caindo e Velocidade caindo desenhavam a mesma coisa. Cada atributo tem desenho próprio agora, e a cor do tipo continua entrando por cima.',
    ],
  },
