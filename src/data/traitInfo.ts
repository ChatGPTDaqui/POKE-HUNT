...
export const DESCRICAO_DA_TRAIT: Record<string, string> = {
  ...
  ice_body: 'Cura 1/16 do HP por turno no granizo E na neve, e nao sofre dano de clima.',
  ...
  snow_cloak: 'Evasao 25% maior no granizo E na neve, e nao sofre dano de clima.',
