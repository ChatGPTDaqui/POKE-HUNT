...
import { NIGHTMARE_MAPS_DATA, NIGHTMARE_ENCOUNTERS_DATA } from './nightmareMaps'
...
function cloneMapsWithOwnPools(mapsData: Record<string, HuntMapDef>): Record<string, HuntMapDef> {
  const out: Record<string, HuntMapDef> = {}
...
const maps: Record<string, HuntMapDef> = { ...cloneMapsWithOwnPools(MAPS_DATA), ...cloneMapsWithOwnPools(NIGHTMARE_MAPS_DATA) }
const encounters: Record<string, HuntEncounter> = { ...ENCOUNTERS_DATA, ...NIGHTMARE_ENCOUNTERS_DATA }

function removeEncounterFromMap(mapId: string, speciesId: string): void {
...
function addEncounterToMap(mapId: string, speciesId: string): void {
  const map = maps[mapId]
...
export const MAPS: Record<string, HuntMapDef> = maps
export const ENCOUNTERS: Record<string, HuntEncounter> = encounters
