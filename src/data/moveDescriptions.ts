...
export const MOVE_DESCRIPTIONS: Record<string, string> = {
  ...
  luster_purge: 'Um clarao psiquico que pode baixar a Defesa Especial do alvo.',
  psycho_boost: 'Um golpe psiquico devastador que esgota o proprio Ataque Especial.',
  ...
  power_trick: 'Troca o proprio Ataque pela propria Defesa.',
  origin_pulse: 'Um jorro de agua azul em feixes que atinge com forca imensa.',
  water_spout: 'Jorra agua com toda a forca; enfraquece conforme o HP do usuario cai.',
  precipice_blades: 'Lancas de pedra brotam do chao e rasgam o alvo.',
  doom_desire: 'Concentra luz e a solta como um golpe de aco no turno seguinte.',
  ...
  needle_arm: 'Golpeia com bracos espinhosos; pode faze-lo recuar.',
  spiky_shield: 'Bloqueia o ataque do turno e machuca quem tentou encostar.',
  attract: 'Apaixona o alvo, que as vezes nao consegue atacar.',
  phantom_force: 'Desaparece num turno e reaparece atacando no seguinte.',
  flash: 'Um clarao que atrapalha a pontaria do alvo.',
  struggle_bug: 'Um contra-ataque de insetos que baixa o Ataque Especial do alvo.',
  tail_glow: 'Acende a cauda e eleva MUITO o proprio Ataque Especial.',
  draining_kiss: 'Um beijo que suga a energia do alvo e cura o usuario.',
  boomburst: 'Uma explosao de som destrutiva que atinge tudo em volta.',
  assist: 'Puxa um golpe de um companheiro de equipe e usa na hora.',
  teeter_dance: 'Uma danca cambaleante que confunde quem esta em campo.',
  thief: 'Ataca e leva o item do alvo junto.',
  shadow_claw: 'Garras de sombra com alta chance de critico.',
  ...
  electric_terrain: 'Eletrifica o chao: ninguem no solo consegue dormir.',
  entrainment: 'Faz o alvo dancar junto e copiar a habilidade do usuario.',
  switcheroo: 'Troca o item com o alvo numa velocidade imperceptivel.',
  poison_tail: 'Uma rabanada venenosa com alta chance de critico; pode envenenar.',
  smelling_salts: 'Dobra de forca contra alvo paralisado — e cura a paralisia dele.',
  frost_breath: 'Um sopro congelante que sai SEMPRE critico.',
  ice_ball: 'Rola como uma bola de gelo, ficando mais forte a cada turno.',
  metal_burst: 'Devolve com juros o ultimo golpe que acertou o usuario.',
  will_o_wisp: 'Fogo-fatuo sinistro que queima o alvo.',
