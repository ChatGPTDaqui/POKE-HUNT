...
export const GOLPES_COM_EFEITO_HARDCODED = new Set([
  'aurora_veil', 'trick_room', 'roar', 'attract', 'quash', 'embargo', 'sleep_talk', 'substitute', 'nature_power',
...
export const MOVE_DESCRIPTIONS: Record<string, string> = {
  aurora_veil: 'Sob granizo ou neve, reduz pela metade danos físicos e especiais por cinco turnos. Não acumula com Reflect ou Light Screen.',
  trick_room: 'Inverte a ordem por Velocidade dos golpes que chegam juntos por cinco turnos. Não altera a recarga. Reutilizar encerra o efeito.',
  return: 'Poder 102 fixo: este jogo não possui atributo de amizade.',
  frustration: 'Poder 102 fixo: este jogo não possui atributo de amizade.',
  volt_switch: 'Causa dano e recua 60 unidades no campo. Aqui não troca automaticamente o POKE da equipe.',
  grass_knot: 'O poder cresce com o peso do alvo, de 20 a 120.',
  facade: 'Dobra o poder com queimadura, veneno ou paralisia e ignora a redução de dano da queimadura.',
  overheat: 'Ataque de fogo poderoso que reduz o próprio Ataque Especial em dois estágios.',
  smart_strike: 'Golpe de Aço que ignora precisão e evasão; imunidades e proteções continuam valendo.',
  confide: 'Reduz o Ataque Especial do alvo em um estágio.',
  focus_blast: 'Ataque especial de Lutador com 10% de chance de reduzir a Defesa Especial do alvo.',
  scald: 'Ataque de Água com 30% de chance de queimar.',
  surf: 'Atinge os inimigos próximos com uma onda de Água.',
  dazzling_gleam: 'Atinge os inimigos próximos com luz do tipo Fada.',
  brutal_swing: 'Atinge os inimigos próximos com um golpe físico do tipo Sombrio.',
  ...
  roar: 'Afasta o alvo e atrasa sua próxima ação em um turno; não concede abate nem loot.',
  ...
  sleep_talk: 'Enquanto dorme, usa um golpe de alvo único da seleção ativa, exceto Rest e Sleep Talk.',
  ...
  fling: 'Arremesso de poder 30 fixo; não consome itens, pois o jogo não possui itens equipados.',
  ...
  quash: 'Atrasa em um turno a ação e os golpes pendentes do alvo.',
  ...
  embargo: 'Bloqueia o uso manual e automático de itens no alvo por cinco turnos.',
  ...
  nature_power: 'Executa Tri Attack; o jogo não possui terrenos de batalha.',
  ...
  attract: 'Por cinco turnos, o alvo tem 50% de chance de perder a ação. Não exige gênero; Oblivious protege.',
