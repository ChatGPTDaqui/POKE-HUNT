...
export const MOVE_DESCRIPTIONS: Record<string, string> = {
  ...
  spotlight: 'Ilumina um alvo e obriga todos a ataca-lo.',
  ...
  switcheroo: 'Troca de item com o alvo antes que ele perceba.',
  ...
  rototiller: 'Revolve a terra e fortalece os tipos Planta em campo.',
  ...
  dragon_claw: 'Rasga o alvo com garras afiadas de dragao.',
  flare_blitz: 'Envolve-se em chamas e arremete; o usuario tambem se queima.',
  shadow_claw: 'Um corte com garras de sombra; alta chance de critico.',
  ...
  electric_terrain: 'Eletrifica o campo: ninguem dorme e golpes Eletricos ficam mais fortes.',
