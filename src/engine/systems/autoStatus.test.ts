...
function cenario(status: StatusCondition, itens: Record<string, number>) {
  ...
  useGameStateStore.setState({
    items: { ...itens },
    autoToggles: { autoPot: false, autoCatch: false, autoRevive: false, autoStatus: true, avancoManualDeSala: false, avancarDeEstagio: false },
  })
...
describe('auto-status', () => {
  ...
  it('respeita o interruptor proprio, e nao mais o do Auto-pocao', () => {
    ...
    useGameStateStore.setState({
      autoToggles: { autoPot: true, autoCatch: false, autoRevive: false, autoStatus: false, avancoManualDeSala: false, avancarDeEstagio: false },
    })
