-- PH-177: novo toggle `avancoManualDeSala` em auto_toggles. `configurar_auto`
-- tem whitelist explicita de chaves (linha "toggle desconhecido: %") — sem
-- este ALTER, o client manda a chave nova no patch e a RPC inteira aborta
-- (a transacao cai fora, nenhum dos outros campos do batch e salvo tambem).
