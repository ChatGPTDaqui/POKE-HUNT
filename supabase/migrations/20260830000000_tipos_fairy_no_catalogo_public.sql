-- PH-247 (dado): alinha `species.type1/type2` com o catalogo canonico do jogo.
--
...
-- iguais. `public.species` e o CATALOGO — a dex 1-251 inteira, alvo de FK.
