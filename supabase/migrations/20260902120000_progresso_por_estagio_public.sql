-- PH-429 (schema public): `players.bioma_progress` deixa de ser tres inteiros
...
--
-- Medido antes de escrever, em 02/09: 8 jogadores no `public`, 4 com progresso
...
begin
  ...
  raise notice 'PH-429 public: % linha(s) convertida(s) do formato de faixa', v_convertidos;
end $$;
