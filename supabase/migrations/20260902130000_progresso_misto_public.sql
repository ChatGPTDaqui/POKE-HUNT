-- PH-440 (schema public): conserta a linha MISTA — a que tem chave de bioma E
...
-- deploy: a migration converteu as 4 linhas de `public`; em seguida o CLIENTE
...
-- chaves de bioma corretas. Duas linhas de `public` ficaram assim, uma delas
-- com os 12 biomas fechados.
--
...
begin
  ...
  raise notice 'PH-440 public: % linha(s) mista(s) corrigida(s)', v_corrigidos;
end $$;
