-- PH-307: espelho de 20260830040000_sequence_hp_public.sql pro schema dev.
...
alter table dev.game_sessions add column if not exists sequence_hp integer;

comment on column dev.game_sessions.sequence_hp is
