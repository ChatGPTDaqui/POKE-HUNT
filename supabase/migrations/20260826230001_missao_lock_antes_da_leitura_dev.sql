-- PH-199 — gemeo dev de
-- `20260826230000_missao_lock_antes_da_leitura_public.sql`. Ver o arquivo
-- public pro raciocinio completo.
begin;
...
begin
  ...
  -- Lock ANTES de qualquer leitura de negocio — ver a nota no gemeo public.
