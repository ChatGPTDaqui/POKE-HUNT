...
create or replace function public.gravar_progresso(p_patch jsonb, p_updated_at_esperado timestamptz)
returns jsonb
language plpgsql
security definer
...
grant execute on function public.gravar_progresso(jsonb, timestamptz) to authenticated;
